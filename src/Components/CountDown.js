...
import { formatDate } from "../Services/url";
  ...
  return (
    <>
      ...
      <Box
        ...
        alignItems={"center"}
      >
        {eventsData.length > 0 && eventsData.map((data) => (
          <Grid
            container
            width={{ md: "75%", xs: "98%" }}
            pb={3}
          ...
          >
            <Box
              ...
              sx={{ background: "linear-gradient(to right, #6D7BFE, #3034BB)" }}
              width={{ md: "70%", xs: "95%" }}
              height={"110px"}
              borderRadius={"30px"}
            >
            ...
            <Grid container mt={2} p={4}>
              ...
              <Grid item xs={12} md={6} p={2}>
                <Typography color={"#100854"} fontSize={"25px"} fontWeight={700}>
                  {data?.name}
                </Typography>
                <Typography color={"#515151"} fontSize={"17px"} fontWeight={400}>
                  {data?.description}
                </Typography>
